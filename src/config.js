const config = {
	...
	metaData: {
		title: 'FateVerse官网🎉',
		description: '欢迎来到FateVerse/命运宇宙服务器！',
		keywords: 'FateVerse,服务器网站,官方网站',
		icon: '/favicon.ico'   //网页图标，支持外链
	},

	avatar: "/img/avatar.jpg", // 头像
	welcometitle: "Hi,Welcome to "," FateVerse Server.", // 标题
	...
	typeWriterStrings: [
		...
		"在方块的荒野中，每个挖掘的方块都藏着命运的伏笔 ——FateVerse 生存服",
		"用圣遗物召唤你的专属伙伴，用选择铺就独一无二的生存之路",
		"是成为守护同伴的 Master，还是征服世界的孤高强者？你的生存，自己定义",
		"当生存遇上 “圣杯战争”，挖矿不再单调，打怪充满策略 ——FateVerse 服务器",
		"既有硬核生存的挑战，也有伙伴羁绊的温暖。挖魔力水晶、建魔术工坊、组队夺圣杯…… 在这里，方块世界的每一步，都是你与命运的博弈",
		"别让生存只是砍树挖矿！来 FateVerse，召唤 Saber 陪你下矿，让 Caster 为你附魔",
		"用 “命运节点” 的选择解锁隐藏剧情。生存的终极意义，不是活下去，而是活成自己想要的传奇 —— 你的故事，从踏入这个方块宇宙开始。"
